...
***/
package com.example.junittest.iloveyouboss_16.domain;

import java.util.*;
import java.util.concurrent.atomic.*;

public class StatCompiler {
   private QuestionController controller = new com.example.junittest.iloveyouboss_16.QuestionController();
   
   public Map<Integer,String> questionText(List<com.example.junittest.iloveyouboss_16.BooleanAnswer> answers) {
   ...
   public Map<String, Map<Boolean, AtomicInteger>> responsesByQuestion(
           List<com.example.junittest.iloveyouboss_16.BooleanAnswer> answers, Map<Integer,String> questions) {
   ...
   private void incrementHistogram(
         Map<Integer, Map<Boolean, AtomicInteger>> responses, com.example.junittest.iloveyouboss_16.BooleanAnswer answer) {
